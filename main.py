...
def task_scrape() : 
    ...
    for i in range(1,3):
        driver.get("https://www.naukri.com/devops-jobs-{}".format(i))
        time.sleep(3)
        ...
        for job in job_container:
            ...
            jd=job.job.find_element_by_tag_name("a").get_attribute("href")
...
try:
    job_csv=task_scrape()
    upload_blob("jobfilecsv",job_csv,"devopsjob.csv")
